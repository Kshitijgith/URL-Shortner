...
router.get("/google", (req, res) => {
  const authUrl = `${GOOGLE_AUTH_URL}?client_id=${process.env.GOOGLE_CLIENT_ID}&redirect_uri=http://16.16.162.71:3001/auth/google/callback&response_type=code&scope=email%20profile&access_type=offline&prompt=consent`;
  ...
  try {
    const response = await axios.post(GOOGLE_TOKEN_URL, null, {
      params: {
        ...
        redirect_uri: 'http://16.16.162.71:3001/auth/google/callback',
