...
const logout=()=>{
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log(token);
      const response = await axios.post("http://16.16.162.71:3001/GenrateUrl",
        {url:url},
        {
        headers: {
          Authorization: token
  ...
  onClick={() => window.location.href = "http://16.16.162.71:3001/auth/google"} // Replace with your URL
>
  Login with Google
</button>:<button
  className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"
